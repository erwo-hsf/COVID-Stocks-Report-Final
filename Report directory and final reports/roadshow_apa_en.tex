...
(\citeproc{ref-Schneider2024quarto}{\textbf{Schneider2024quarto?}}) and
the \LaTeX~package apa7
(\citeproc{ref-Weiss2022Formatting}{\textbf{Weiss2022Formatting?}}). For
the most part, it is designed in accordance with APA stlye (7th Edition)
guidelines. However, some adjustments have been made to conform to the
formatting requirements specified in the ``Handbook of Academic
Writing''
(\citeproc{ref-Hildebrandt2019Handbook}{\textbf{Hildebrandt2019Handbook?}}).
...
(\citeproc{ref-ConciseGuideAPA2020}{\textbf{ConciseGuideAPA2020?}}),
also known as the APA rules in the 7th Edition. This template was
written by me, Prof.~Dr.~Stephan Huber\footnote{Email:
  \texttt{stephan.huber@hs-fresenius.de}}. I have adapted the Quarto
extension \texttt{apaquarto} from
(\citeproc{ref-Schneider2024quarto}{\textbf{Schneider2024quarto?}}) and
the \LaTeX~package apa7
(\citeproc{ref-Weiss2022Formatting}{\textbf{Weiss2022Formatting?}}). The
title page was created according to the specifications of the University
of Applied Science Fresenius. In comparison to APA 7 a few little things
differ. For example, the headings have different font sizes and the line
spacing is 1.5.\\
...
Quarto, you can get a lot of information from
(\citeproc{ref-Schneider2024quarto}{\textbf{Schneider2024quarto?}}) and
the website \url{https://quarto.org/}.
...
\pandocbounded{\includegraphics[keepaspectratio]{logo.png}}
...
In the Appendix \textbf{?@sec-Ap1}, you find another exampl, that is,
Figure~\ref{fig-logo4}. Appendix \textbf{?@sec-Ap2} contains
...
Appendix \textbf{?@sec-bibtexfile} you find the BibTeX entries for
...
\bottomrule\noalign{}
\endlastfoot
\texttt{@Huber2016} & (\citeproc{ref-Huber2016}{\textbf{Huber2016?}}) \\
\texttt{@Huber2016{[}2{]}} &
(\citeproc{ref-Huber2016}{\textbf{Huber2016?}}) \\
\texttt{{[}@Huber2016{]}} &
(\citeproc{ref-Huber2016}{\textbf{Huber2016?}}) \\
\texttt{{[}@Huber2016,\ 3-5{]}} &
(\citeproc{ref-Huber2016}{\textbf{Huber2016?}}) \\
...
(\citeproc{ref-Huber2016}{\textbf{Huber2016?}};
\citeproc{ref-Aust2023}{\textbf{Aust2023?}}) \\
...
\citeproc{ref-Google2023Google}{\textbf{Google2023Google?}}).

\subsection{Various Formats}

Here are some fictitious examples of different types of literature:
(\citeproc{ref-unpublished}{\textbf{unpublished?}}),
(\citeproc{ref-techreport}{\textbf{techreport?}}),
(\citeproc{ref-phdthesis}{\textbf{phdthesis?}}),
(\citeproc{ref-misc}{\textbf{misc?}}),
(\citeproc{ref-mastersthesis}{\textbf{mastersthesis?}}),
(\citeproc{ref-incollection}{\textbf{incollection?}}),
(\citeproc{ref-inbook}{\textbf{inbook?}}),
(\citeproc{ref-conference}{\textbf{conference?}}),
(\citeproc{ref-booklet}{\textbf{booklet?}}),
(\citeproc{ref-book}{\textbf{book?}}),
(\citeproc{ref-article}{\textbf{article?}}),
(\citeproc{ref-proceedings}{\textbf{proceedings?}}),
(\citeproc{ref-webpage}{\textbf{webpage?}}).

The corresponding bibtex file should contain the entries. They are
displayed in \textbf{?@sec-bibtexfile}.
...
\section{Additional Figures}\label{apx-sec-Ap1}
...
\section{Second Attachment}\label{apx-sec-Ap2}
...
\section{BibTex file}\label{apx-sec-bibtexfile}
